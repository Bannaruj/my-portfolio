...
export default function PortfolioPage() {
  const skillCategories = [
    {
      ...
      skills: [
        ...
        },
        {
          title: "CSS",
          icon: (
            <Image src={CSSIcon} alt="CSS" className="w-8 h-8 object-contain" />
          ),
        },
        {
          title: "JavaScript",
        ...
        },
        {
          title: "PHP",
          icon: (
            <Image src={PHPIcon} alt="PHP" className="w-8 h-8 object-contain" />
          ),
        },
        {
          title: "TypeScript",
        ...
        },
        {
          title: "C++",
          icon: (
            <Image src={CppIcon} alt="C++" className="w-8 h-8 object-contain" />
          ),
        },
      ],
    },
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Goal money management app for tracking incoming and outgoing money.",
      tags: ["Flutter"],
    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-sans selection:bg-indigo-100">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <h2 className="text-xl md:text-2xl text-zinc-600 font-medium mb-10 max-w-2xl leading-relaxed">
            Crafting scalable web experiences & robust mobile applications.{" "}
          ...
          <div className="flex items-center space-x-4">
            <a
              href="mailto:sag655as@gmail.com"
              className="bg-zinc-900 text-white px-8 py-3.5 rounded-lg font-medium hover:bg-zinc-800 transition-all flex items-center group shadow-md hover:shadow-lg"
            >
            ...
            <div className="flex items-center space-x-2">
              <a
                href="https://github.com/Bannaruj"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3.5 bg-white text-zinc-600 hover:text-indigo-600 border border-zinc-200 rounded-lg hover:border-indigo-200 transition-all shadow-sm"
              >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-16">
            ...
            <p className="text-zinc-600 max-w-2xl text-lg">
              Fluent in multiple programming languages and web technologies,
              capable of building robust cross-platform applications.
            </p>
          </div>
          <div className="space-y-16">
            {skillCategories.map((category, catIndex) => (
              <div key={catIndex}>
                <h4 className="text-2xl font-bold text-zinc-800 mb-8 pb-2 border-b border-zinc-100">
                  {category.title}
                </h4>
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6">
                  {category.skills.map((skill, index) => (
                    <div
                      key={index}
                      className="p-6 border border-zinc-100 rounded-2xl bg-zinc-50/50 hover:bg-white hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-300 group"
                    >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-16 flex justify-between items-end">
            <div>
              ...
              <p className="text-zinc-600 max-w-2xl text-lg">
                A showcase of production-ready applications spanning web and
                mobile platforms.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="group bg-white rounded-3xl overflow-hidden border border-zinc-200/60 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col"
              >
                <div
                  className={`h-48 w-full ${project.color} relative overflow-hidden flex items-center justify-center p-6`}
                >
                  {project.image ? (
                    <Image
                      src={project.image}
                ...
                <div className="p-8 flex-1 flex flex-col">
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-xs font-semibold px-2.5 py-1 bg-zinc-100 text-zinc-600 rounded-md"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center text-indigo-600 font-semibold text-sm hover:text-indigo-700 group-hover:underline decoration-2 underline-offset-4"
                  >
                    View Project{" "}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-16 text-center">
            ...
            <p className="text-zinc-600 max-w-2xl mx-auto text-lg">
              Continuous learning and validated expertise across
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {certificates.map((cert, index) => (
              <div
                key={index}
                className="flex-none basis-full md:basis-[calc(50%-12px)] lg:basis-[calc(33.333%-16px)]"
              >
      ...
      <footer className="py-12 bg-zinc-900 text-zinc-400 text-center border-t border-zinc-800">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
          <span className="font-bold text-2xl tracking-tight text-white mb-6">
            BL.
          </span>
          <p className="mb-6 max-w-md mx-auto">
            Building intelligent software solutions with a focus on design,
          ...
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Bannaruj Limsomwong. All rights
            reserved.
          </p>
        </div>
      </footer>
