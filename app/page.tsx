      ...
      <section id="about" className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <div className="flex items-center space-x-4">
            <a href="mailto:sag655as@gmail.com" className="bg-zinc-900 text-white px-8 py-3.5 rounded-lg font-medium hover:bg-zinc-800 transition-all flex items-center group shadow-md hover:shadow-lg">
      ...
      <footer className="py-12 bg-zinc-900 text-zinc-400 text-center border-t border-zinc-800">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
          ...
          <div className="flex space-x-6 mb-8">
            ...
            <a href="mailto:sag655as@gmail.com" className="hover:text-white transition-colors"><Mail className="w-5 h-5" /></a>
          </div>
          <p className="text-sm">
